...
export default function Dashboard() {
  ...
  const chartData = [
    ...
    { name: "الاثنين", value: stats.weekProfit * 0.2 },
  ...
  const cards = [
    ...
    { title: "مهام اليوم", value: stats.totalTasks.toString(), icon: ListTodo, color: "bg-purple-500", light: "bg-purple-50" },
    { title: "مهام قيد الانتظار", value: stats.pendingTasks.toString(), icon: ListTodo, color: "bg-amber-500", light: "bg-amber-50" },
    { title: "منتجات منخفضة المخزون", value: stats.lowStockProducts.toString(), icon: CircleAlert, color: "bg-orange-500", light: "bg-orange-50" },
    { title: "توصيلات بانتظار المراجعة", value: stats.pendingDeliveries.toString(), icon: Truck, color: "bg-cyan-500", light: "bg-cyan-50" },
